...
" new HTML5 tag name
syn keyword htmlTagName contained article aside header footer audio canvas command datalist
syn keyword htmlTagName contained details embed figcaption figure hgroup mark meter
syn keyword htmlTagName contained nav output progress section source
