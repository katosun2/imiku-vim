...
syntax keyword javaScriptStatement      try catch throw with finally eval
...
syntax keyword javaScriptFunctionKeys   abs match split slice join push test floor ceil parseInt setTimeout setInterval clearTimeout clearInterval replace random reload encodeURI encodeURIComponent enctype escape charAt stringify write writeln isNaN galleryImg getAttention getAttribute getAttributeNS getAttributeNode getAttributeNodeNS getDate getDay getElementById getElementsByName getElementsByTagName getElementsByTagNameNS getFullYear getHours getMilliseconds getMinutes getMonth getRangeAt getSeconds getSelection getTime getTimezoneOffset getUTCDate getUTCDay getUTCFullYear getUTCHours getUTCMilliseconds getUTCMinutes getUTCMonth getUTCSeconds getYear hasAttribute hasAttributeNS hasAttributes hasChildNodes setUTCDate setUTCFullYear setUTCHours setUTCMilliseconds setUTCMinutes setUTCMonth setUTCSeconds setYear round setAttribute setAttributeNS setAttributeNode setAttributeNodeNS setDate setFullYear setHours setMilliseconds setMinutes setMonth setSeconds setTime removeAllRanges removeAttribute removeAttributeNS removeAttributeNode removeChild removeEventListener removeRange
syntax keyword javaScriptProperty   length hostname host keyCode ctrlKey navigator stopPropagation cancelBubble

"" DOM/HTML/CSS specified things

  " DOM2 Objects
  syntax keyword javaScriptGlobalObjects  DOMImplementation DocumentFragment document attributes Document Node NodeList NamedNodeMap CharacterData Attr Element Text Comment CDATASection DocumentType Notation Entity EntityReference ProcessingInstruction documentElement createAttribute createCaption createDocumentFragment createElement createElementNS createEvent createNSResolver createRange createTFoot createTHead createTextNode scrollTop scrollLeft innerHeight innerWidth outerHeight outerWidth childNodes nodeName nodeType nodeValue offsetHeight
  ...
  syntax case ignore
  syntax keyword javaScriptHtmlEvents     onResize onblur onclick oncontextmenu ondblclick onfocus onkeydown onkeypress onkeyup onmousedown onmousemove onmouseout onmouseover onmouseup onresize
  syntax case match
...
"" Code blocks
syntax cluster javaScriptAll       contains=javaScriptComment,javaScriptLineComment,javaScriptDocComment,javaScriptStringD,javaScriptStringS,javaScriptRegexpString,javaScriptNumber,javaScriptFloat,javaScriptLabel,javaScriptSource,javaScriptType,javaScriptOperator,javaScriptBoolean,javaScriptNull,javaScriptFunction,javaScriptConditional,javaScriptRepeat,javaScriptBranch,javaScriptStatement,javaScriptGlobalObjects,javaScriptExceptions,javaScriptFutureKeys,javaScriptDomErrNo,javaScriptDomNodeConsts,javaScriptHtmlEvents,javaScriptDotNotation,javaScriptFunctionKeys,javaScriptProperty
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink javaScriptOperator             Function
  ...
  HiLink javaScriptFunctionKeys         Function
  HiLink javaScriptProperty             Special
