...
syn keyword cssTagName article aside header footer audio canvas command
syn keyword cssTagName datalist details figcaption figure hgroup mark
syn keyword cssTagName nav output progress section source meter
