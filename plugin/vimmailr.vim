...
function VimMailrSend()
	...
	let strRet = libcall($VIMFILES."/bin/vimmailr/vimmailr.dll", "VimSendMail", expand('%:p'))
...
" Maps
map <leader>vms  :call VimMailrSend()<cr>
map <leader>vmh  :call VimMailrMakeHeader()<cr>
map <leader>vmm  :call VimMailrQuickMessage()<cr>
map <leader>vmf  :call VimMailrMailFile()<cr>
